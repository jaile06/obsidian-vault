...
sources: ["[[Karpathy筆記術-Claude Code建立知識庫]]", "[[EP08-Obsidian打造AI筆記流]]", "[[Karpathy-LLM Wiki原文]]", "[[Martina在进化-AI第二大腦告別靈感焦慮]]", "[[Lewis搞事日記-Karpathy知識庫SKILL]]"]
created: 2026-04-17
updated: 2026-05-05
---
...
### Outputs 層（Martina 補充）

- 完整三層：**raw**（輸入）/ **wiki**（整理）/ **outputs**（創作產出）
- outputs 層存放寫作草稿、選題報告、影片大綱等產出
- 工作流閉環：raw → wiki（AI整理）→ outputs（AI挖掘素材 + 人工修稿）
